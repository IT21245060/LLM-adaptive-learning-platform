...
import { saveQuizResult } from "@/actions/programming/results";
import QuizContent from "@/components/programming/quiz/QuizContent";
import WelcomeCard from "@/components/programming/welcome-quiz/WelcomeCard";
import { useAuth } from "@/context/AuthContext";
import apiRequest from "@/lib/programming/api-client";
import useQuizStore from "@/store/programming/quiz";
...
import { getQuizTimeSpent } from "@/lib/programming/quiz-utils";
import { updateUserLevelBasedOnQuizResult } from "@/actions/programming/user";
...
const QuizPage = () => {
  ...
  const handleCompletedExams = () => {
    router.push(`/programming/programming-exams?module=${encodeURIComponent(module)}`);
  }
  ...
  const handleQuizComplete = async (answers: Record<string, string>) => {
    ...
    try {
      ...
      if (user?.uid) {
        ...
        clearStore();
        router.push(`/programming/quiz/result?id=${resultExam.id}`);
