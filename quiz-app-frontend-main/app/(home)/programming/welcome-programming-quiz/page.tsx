...
import { saveUserLevel } from "@/actions/programming/user";
import AssignedLevelModal from "@/components/programming/modals/AssignedLevelModal";
...
import { ProgrammingQuestion, ExamAndQuestions } from "@/types/programming";
...
const WelcomeProgrammingQuizPage = () => {
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      ...
      router.push(`/programming/quiz?module=${encodeURIComponent(selectedModule)}`);
    } catch (error) {
