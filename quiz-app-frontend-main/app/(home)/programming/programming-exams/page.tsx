...
import { Exam } from "@/types/programming";
...
const ProgrammingExams = () => {
  ...
  const handleBack = () => {
    router.push(`/programming/quiz?module=${encodeURIComponent(module as string)}`);
  }
                        ...
                        <div className="m-4 bg-background overflow-hidden rounded-md border" key={tableData[0].value}>
                          ...
                          <div className="flex justify-center items-center mt-2 mb-2 gap-4 w-sm mx-auto">
                            <Button
                              variant="secondary"
                              className="flex-1"
                              onClick={() => router.push(`/programming/quiz/review?id=${tableData[0].value}`)}
                            >
                              Review Answers
                            </Button>
