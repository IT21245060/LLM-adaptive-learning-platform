    ...
    <Card className="overflow-hidden p-0 min-w-md lg:w-4/5">
      <CardContent className="grid p-0 lg:grid-cols-2">
        <div className="relative hidden lg:block">
          <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-emerald-500 to-teal-500 opacity-60" />
          <div className="absolute inset-0 h-full w-4/5 m-auto mt-20 z-20">
            <h1 className="text-4xl font-bold text-background">
              Welcome To Cogni Learn
            </h1>
            <p className="mt-2 text-background font-semibold">
              {
                "Welcome to Cogni Learn! Challenge your knowledge, test your skills, and climb the leaderboard. Register now to unlock exciting quizzes, track your progress, and compete with friends. Let's get started!"
              }
            </p>
          </div>
          <Image
